            ...
            <div>
              ...
              <div className="relative">
                <input
                  id="cpf"
                  type="text"
                  className={`w-full px-4 py-3 border ${cpfError ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 ${cpfError ? 'focus:ring-red-500' : 'focus:ring-blue-500'} focus:border-transparent text-gray-700`}
