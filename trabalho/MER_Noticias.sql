...
(
    ...
    '2025-05-10',
    LOAD_FILE('../../../public/noticias.imgs/not1.png'),
    1,
    'Educação'
),
(
    ...
    '2025-05-12',
    LOAD_FILE('../../../public/noticias.imgs/not2.png'),
    2,
    'Esporte'
),
(
    ...
    '2025-05-15',
    LOAD_FILE('../../../public/noticias.imgs/not3.png'),
    3,
    'Educação'
),
(
    ...
    '2025-04-30',
    LOAD_FILE('../../../public/noticias.imgs/not4.png'),
    4,
    'Tecnologia'
),
(
    ...
    '2025-04-27',
    LOAD_FILE('../../../public/noticias.imgs/not5.png'),
    5,
    'Educação'
);
(
    ...
    '2025-05-15',
    LOAD_FILE('../../../public/noticias.imgs/not6.png'),
    6,
    'Educação'
);
(
    ...
    '2025-05-25',
    LOAD_FILE('../../../public/noticias.imgs/not7.png'),
    7,
    'Tecnologia'
);
(
    ...
    '2025-05-22',
    LOAD_FILE('../../../public/noticias.imgs/not8.png'),
    8,
    'Educação'
);
(
    ...
    '2025-05-15',
    LOAD_FILE('../../../public/noticias.imgs/not9.png'),
    9,
    'Sustentabilidade'
);
(
